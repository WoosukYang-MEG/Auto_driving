...
class LineCheck_Edge:
    def __init__(self):
        self.cap = cv2.VideoCapture("solidWhiteRight.mp4")
        ...
        while self.cap.isOpened():
            ...
            self.line_arr, self.slope_degrees = self.slope_limit(self.line_arr, self.slope_degrees, 140, 155) # 95도 160도로 제한
    ...
    def region_of_interest(self, img):
        polygons = np.array([
        [(100, 500),(920 ,500),(500, 280)]       # triangle의 세 꼭지점
        ])
    ...
    def draw_roi(self, img,color=[0,255,0], thickness=2): # 선 그리기
        cv2.line(img, (920, 500), (500, 280), color, thickness)
        cv2.line(img, (100, 500), (500, 280), color, thickness)
